          ...
          :code $ quote $ defcomp comp-container (reel)
            let
                ...
                state $ or (:data states)
                  {} $ :content |
              div ({})
                if-not hide-tabs? $ comp-hud-nav (:tab store) tabs $ fn (next d!)
                  d! $ :: :tab next
      ...
      :defs $ {}
        'default-tab $ %{} 'CodeEntry (:doc |)
          :code $ quote $ def default-tab
            turn-tag $ get-env |tab $ turn-string
              nth (last tabs) 0
          :examples $ []
          :schema $ :: 'Dynamic
        'dev? $ %{} 'CodeEntry (:doc |)
        ...
        'tabs $ %{} 'CodeEntry (:doc |)
          :code $ quote $ def tabs
            [] (:: :fireworks |Fireworks :dark) (:: :lorenz |Lorenz :dark) (:: :aizawa |Aizawa :dark) (:: :fourwing "|Four Wing" :dark) (:: :fractal |Fractal :dark) (:: :collision |Collision :dark) (:: :bounce |Bounce :dark) (:: :feday |FEDAY :dark) (:: :bifurcation |Bifurcation :dark) (:: :ball-spin "|Ball Spin" :dark) (:: :lifegame |Lifegame :dark) (:: :lifegame-trail "|Lifegame Trail" :dark) (:: :bounce-trail "|Bounce Trail" :dark) (:: :orbit-spark "|Orbit Spark" :dark) (:: :chen |Chen :dark) (:: :sprott |Sprott :dark) (:: :lorenz83 |Lorenz83 :dark) (:: :orbits |Orbits :dark) (:: :lamps |Lamps :dark) (:: :debug-grid "|Debug Grid" :dark) (:: :den-tsucs "|Den Tsucs" :dark) (:: :bouali |Bouali :dark) (:: :orbits2 "|Orbits 2" :dark) (:: :halvorsen |Halvorsen :dark) (:: :clifford |Clifford :dark) (:: :dequanli "|Dequan Li" :dark) (:: :dadras |Dadras :dark) (:: :burke-shaw "|Burke Shaw" :dark) (:: :quadratic |Quadratic :dark) (:: :rule1001 |rule1001 :dark)
          :examples $ []
          :schema $ :: 'Dynamic
        'threshold $ %{} 'CodeEntry (:doc |)
          :code $ quote $ def threshold
            js/parseFloat $ or (get-env |threshold) |0.016
          :examples $ []
          :schema $ :: 'Dynamic
        'use-gamepad? $ %{} 'CodeEntry (:doc |)
          :code $ quote $ def use-gamepad? (get-env |gamepad)
          :examples $ []
          :schema $ :: 'Dynamic
      :ns $ %{} 'NsEntry (:doc |)
        :code $ quote $ ns app.config
          :require $ app.schema :refer $ tabs
    'app.main $ %{} 'FileEntry
      :defs $ {}
        ...
        'main! $ %{} 'CodeEntry (:doc |)
          :code $ quote $ defn main! ()
            ...
            js-await $ set-renderer! $ :tab (:store @*reel)
            render-loop!
